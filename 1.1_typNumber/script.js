...
const newTxt = txt.toLocaleUpperCase(); //.toUpperCase() czemu nie?
...
const numberOBj1 = new Number(); //bez podania wartości zwróci zero 0
...
// parseInt() pozwala nam zmienić stringa w number. Najpierw podajemy string (w któryma jest liczba) a potem możemy powiedzieć w jakim jest systenie. Wynikiem działania funkcji będzie number w zapisie dziesiętnym
parseInt("20", 10); //20
parseInt("100", 2); //4
